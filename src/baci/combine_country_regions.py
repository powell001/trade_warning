...
def country_mappings():
  baci_country = pd.read_csv(r"src\baci\data\country_codes_V202301.csv", usecols=['country_code', 'iso_3digit_alpha'])
  baci_country.to_csv("bacixxx.csv")
  ### Make Hong part of China (sorry Hong Kong)
  #baci_country[baci_country['country_code'] == 344] = 156
  #baci_country[baci_country['country_code'] == 344] = 156

  iso_regions = pd.read_csv(r"src\baci\data\iso_countries_regions.csv", usecols=['name', 'alpha-3', 'region_eu'])
